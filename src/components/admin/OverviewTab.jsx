    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-medium bg-neutral-800 hover:bg-neutral-700 text-white border border-neutral-700 transition-colors cursor-pointer"
        >
        ...
        {stats.map((stat, idx) => {
          ...
          return (
            <div
              ...
              className="p-5 rounded-2xl bg-neutral-900 border border-neutral-800 hover:border-neutral-700 cursor-pointer transition-all hover:scale-[1.02] shadow-xs flex flex-col justify-between"
            >
              ...
              <div className="space-y-3">
                {messages.slice(0, 3).map((m) => (
                  <div
                    key={m._id || m.id}
                    onClick={() => onTabChange("messages")}
                    className="p-2.5 rounded-xl bg-neutral-950 border border-neutral-800 hover:border-neutral-700 cursor-pointer transition-colors"
                  >
