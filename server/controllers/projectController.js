...
export const createProject = async (req, res) => {
  try {
    ...
    const rawCatgry = catgry !== undefined ? catgry : (category !== undefined ? category : "");
    ...
    const newProject = await db.createProject({
      ...
      catgry: targetCatgry || "Full Stack",
      category: targetCatgry || "Full Stack",
    });
...
export const updateProject = async (req, res) => {
  try {
    ...
    // Resolve category / catgry based on user input
    if (body.catgry !== undefined) {
      const cleanCatgry = typeof body.catgry === "string" ? body.catgry.trim() : body.catgry;
      body.catgry = cleanCatgry;
      body.category = cleanCatgry;
    } else if (body.category !== undefined) {
      const cleanCatgry = typeof body.category === "string" ? body.category.trim() : body.category;
      body.catgry = cleanCatgry;
      body.category = cleanCatgry;
    }
